...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        stationsFragment1 = StationsFragment.newInstance(StationsFragment.STATION_TYP_FEATURED);
        fm.beginTransaction().add(R.id.container_top_row, stationsFragment1).commit();

        stationsFragment2 = StationsFragment.newInstance(StationsFragment.STATION_TYP_RECENT);
        fm.beginTransaction().add(R.id.container_middle_row, stationsFragment2).commit();

        stationsFragment3 = StationsFragment.newInstance(StationsFragment.STATION_TYP_PARTY);
